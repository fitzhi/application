...
/**
 * <p>
 * Class in charge of the test of {@link com.fitzhi.controller.ProjectAnalysisController#skyline()}
 * </p>
...
public class ProjectAnalysisControllerSkyline2Test {
	...
	public void testCallSkyline() throws Exception {
		...
		MvcResult result = mvc.perform(get("/api/project/analysis/skyline")
