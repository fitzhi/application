...
@SpringBootTest
public class GitCrawlerRetrieveConnectionTest {
	...
	public void testConnectionPublic() throws Exception {
		...
		Assert.assertNotNull(scanner.retrieveFetchConnection(project));
	}
	...
	public void testConnectionFailed() throws SkillerException {
		...
		Assert.assertNull(scanner.retrieveFetchConnection(project));
	}
