...
public interface StaffHandler extends DataSaverLifeCycle {
	...
	/**
	 * Each slave might create new staff members. Their ID will start from this offset.
	 * The Main application will use this OFFSET to identify these new staff, member and provide them a global with the medhod {@link #nextIdStaff()}}
	 */
	public final int SLAVE_OFFSET = 1000000;
	...
	/**
	 * <p>
	 * Create a <strong>FAKE</strong> staff member with the ID {@link #SLAVE_OFFSET}.
	 * </p> 
	 * <p>
	 * Each slave might create new staff members. Their ID will start from this offset.
	 * The Main application will use this OFFSET to identify these new staff, member and provide them a global with the medhod {@link #nextIdStaff()}}
	 ...
	 * @see #controlWorkforceMember(Staff)
	 */
	void updateStaff(Staff staff) throws ApplicationException;

	/**
	 * <p>
	 * Update the registered collection of staff members with a subset of staff member generated by a slave.
	 * </p>
	 * 
	 * @param project project analyzed by the slave 
	 * @param staff the staff collection to be taken in account.
	 ...
	 * </p>
	 * <p>
	 * This operation is executed by the end-user with the Front application.
	 * Therefore, all GIT statistics on commit are null, or equal to 0 (<em>dates of commit, number of commits, number of files</em>).
	 * </p>
	 * 
	 * @param idStaff     the staff identifier
	 * @param idProject   the project identifier
	 ...
	 */
	void addMission(Staff staff, Mission mission);
	...
	/**
	 * <p>
	 * Test if the given project is referenced by the given staff member.
	 * </p>
	 * 
	 * @param idStaff   the staff identifier
	 * @param idProject the project identifier
	 * @return {@code TRUE} if there is a mission concerning the project, {@code FALSE} otherwise.
	 */
	boolean hasMission(int idStaff, int idProject) throws NotFoundException;
	 ...
	 * The search is <strong>GLOBAL</strong> for all staff members, either active, or inactive.
	 * </p>
	 * 
	 * @param idProject the project identifier
