...
public enum SkillDetectorType {
	...
	@SerializedName("1") PACKAGE_JSON_DETECTOR_TYPE (1, "Dependency detection in package.json"), 
	@SerializedName("2") POM_XML_DETECTOR_TYPE (2, "Dependency detection in pom.xml"); 
