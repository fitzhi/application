...
@Api(
	...
	description = "API endpoints to manage the audits generated by the application."
)
public class ProjectAuditController extends BaseRestController {
	 ...
	 */
	@GetMapping(path="/audit/loadTopic/{idProject}/{idTopic}")
	...
	@PostMapping(path="/audit/removeTopic")
	...
	@PostMapping(path="/audit/saveEvaluation")
	...
	@PostMapping(path="/audit/saveReport")
	public ResponseEntity<Boolean> saveReport(@RequestBody BodyParamAuditEntry param) throws ApplicationException {
