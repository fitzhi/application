...
export class TurnoverService {
	 ...
	 * @param external filter or not the external developers _If **TRUE**, the external developers should be included
	 * in the turnover calculation ?_
	 * @returns the turnoverDara container : the intermediate subtotals and the resulting turnover, which might be equal to -1,
	 * if calculation is impossible.
	 */
