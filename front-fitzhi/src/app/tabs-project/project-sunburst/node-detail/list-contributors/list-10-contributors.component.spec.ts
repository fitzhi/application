...
describe('ListContributorsComponent (10 elements)', () => {
	...
	class TestHostComponent {
		...
		constructor() {
			localStorage.setItem('list-contributors.pageSize', '10');
	...
	it('should display 10 contributors', () => {
		...
		const contributor = fixture.debugElement.query(By.css('#contributor-10'));
