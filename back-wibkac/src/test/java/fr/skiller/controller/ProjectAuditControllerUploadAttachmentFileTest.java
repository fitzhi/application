...
public class ProjectAuditControllerUploadAttachmentFileTest {
	...
	public void testAddFirstAttachment() throws Exception {
		...
		unloadfile(UPLOAD_FILENAME_DOCX, FileType.FILE_TYPE_DOCX.getValue());
	...
	private void unloadfile(String filename, int fileType) {
	...
	public void testAddSecondAttachment() throws Exception {
		...
		unloadfile(UPLOAD_FILENAME_DOCX, FileType.FILE_TYPE_DOCX.getValue());
		unloadfile(UPLOAD_FILENAME_PDF, FileType.FILE_TYPE_PDF.getValue());
