...
import com.tixhi.source.crawler.git.SourceChange;
...
public class GitCrawlerNonRelevantDependenciesMgtTest {
	...
	public void testRetrieveRootPath1() throws IOException {
		...
		analysis.addChange( "src/main/java/com/tixhi/data/source/importance/FileSizeImportance.java",
				new SourceChange("1",  LocalDate.now(), "fvi", "fvi@void.com") );
		analysis.addChange( "src/main/java/com/tixhi/data/source/importance/AssessorImportance.java",
				new SourceChange("2", LocalDate.now(), "fvi", "fvi@void.com") );
		analysis.addChange( "src/main/java/com/tixhi/data/source/importance/ImportanceCriteria.java",
				new SourceChange("3", LocalDate.now(), "fvi", "fvi@void.com") );
		analysis.addChange( "src/main/java/com/tixhi/data/source/CommitHistory.java",
				new SourceChange("4",  LocalDate.now(), "fvi", "fvi@void.com") );
		analysis.addChange( "src/main/java/com/tixhi/data/source/CommitRepository.java",
				new SourceChange("5", LocalDate.now(), "fvi", "fvi@void.com") );
		analysis.addChange( "src/main/java/com/tixhi/data/source/operation.java",
				new SourceChange("6",  LocalDate.now(), "fvi", "fvi@void.com") );
		
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/importance/FileSizeImportance.java");
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/importance/AssessorImportance.java");
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/importance/ImportanceCriteria.java");
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/CommitHistory.java");
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/CommitRepository.java");
		analysis.getPathsAdded().add("src/main/java/com/tixhi/data/source/operation.java");

		analysis.getPathsCandidate().add("src/main/java/com/tixhi/data/source/importance");
