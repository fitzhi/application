...
public class StaffController_uploadResume_Test {
	...
	public void shouldUploadFile() throws Exception {
		...
		ResponseEntity<DeclaredExperienceDTO> response = this.restTemplate.postForEntity("/staff/api/uploadCV", map,
				DeclaredExperienceDTO.class);

		assertThat(response.getStatusCode()).isEqualByComparingTo(HttpStatus.OK);
		assertThat(response.getBody().experience.containsKey("C#"));
		assertThat(response.getBody().experience.containsKey("Java"));
		assertThat(response.getBody().experience.containsKey("Sping"));
